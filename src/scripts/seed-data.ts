    ...
    try {
        ...
        const restaurants = await RestaurantModel.insertMany([
            ...
            },
            {
                ...
                description: "Authentic Korean flavors — bibimbap, tteokbokki, Korean fried chicken, and sizzling BBQ right at your table.",
                rating: 4.7,
                deliveryTime: "30-40 mins",
                deliveryFee: 65,
                categories: ["Korean", "Asian", "BBQ"],
                address: "Jhamsikhel, Lalitpur",
                phone: "01-4567898",
                isOpen: true,
            },
            {
                ...
                description: "Authentic Thakali cuisine from the Mustang region — traditional Thakali Khana Set, Dhido, Khaja Set, and wholesome Nepali comfort food.",
                rating: 4.9,
                deliveryTime: "20-30 mins",
                deliveryFee: 30,
                categories: ["Nepali", "Thakali", "Traditional"],
        ...
        foods.push(
            {
                ...
                name: "Whopper",
                image: "https://images.unsplash.com/photo-1550547660-d9450f859349?w=500",
                description: "Flame-grilled chicken patty with fresh vegetables and special sauce.",
                price: 550,
                category: "Burger",
                rating: 4.7,
                isPopular: true,
            ...
            {
                restaurantId: restaurants[2]._id,
                name: "Double Chicken Combo",
                image: "https://images.unsplash.com/photo-1553979459-d2229ba7433b?w=500",
                description: "Double chicken patty burger with large fries and drink.",
                price: 950,
                category: "Combo",
                rating: 4.8,
                isPopular: true,
        ...
        // Sushi World Foods — Dragon Roll removed, replaced with Tuna Roll
        foods.push(
            {
                restaurantId: restaurants[6]._id,
                name: "Salmon Sushi Roll",
            ...
            },
            {
                ...
                description: "Fresh tuna with cucumber and sesame seeds in sushi rice.",
                price: 700,
                category: "Sushi",
                rating: 4.8,
                isPopular: true,
        ...
        // The Grill House Foods — replaced any beef with chicken/lamb
        foods.push(
            {
                restaurantId: restaurants[7]._id,
                name: "BBQ Chicken Ribs",
                image: "https://images.unsplash.com/photo-1544025162-d76694265947?w=500",
                description: "Slow-smoked chicken ribs with signature BBQ glaze.",
                price: 1200,
                category: "BBQ",
                rating: 4.8,
                isPopular: true,
            ...
            },
            {
                ...
                name: "Mixed Grill Platter",
                image: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=500",
                description: "A mix of grilled chicken, lamb, and fish with sides.",
                price: 1800,
                category: "Grill",
                rating: 4.9,
                isPopular: true,
        ...
        foods.push(
            ...
            },
            {
                restaurantId: restaurants[8]._id,
                name: "Tteokbokki",
                image: "https://images.unsplash.com/photo-1635363638580-c2809d049eee?w=500",
            ...
            },
            {
                ...
                name: "Kimchi Jjigae",
                image: "https://images.unsplash.com/photo-1498654896293-37aacf113fd9?w=500",
                description: "Hearty kimchi stew with tofu and pork, served with rice.",
                price: 480,
                category: "Korean",
                rating: 4.6,
                isPopular: false,
        ...
        // Thakali Kitchen Foods
        foods.push(
            {
                restaurantId: restaurants[9]._id,
                name: "Thakali Khana Set (Chicken)",
                image: "https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=500",
                description: "Traditional Thakali set with chicken curry, dal, rice, ghee, achar, and seasonal vegetables.",
                price: 450,
                category: "Thakali",
                rating: 4.9,
                isPopular: true,
            ...
            {
                restaurantId: restaurants[9]._id,
                name: "Thakali Khana Set (Mutton)",
                image: "https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=500",
                description: "Traditional Thakali set with tender mutton curry, dal, rice, ghee, achar, and seasonal vegetables.",
                price: 550,
                category: "Thakali",
                rating: 4.9,
                isPopular: true,
            ...
            {
                restaurantId: restaurants[9]._id,
                name: "Thakali Khana Set (Fish)",
                image: "https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=500",
                description: "Traditional Thakali set with fried fish, dal, rice, ghee, achar, and seasonal vegetables.",
                price: 500,
                category: "Thakali",
                rating: 4.8,
                isPopular: true,
            },
            {
                ...
                name: "Dhido Set",
                image: "https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=500",
                description: "Traditional Nepali Dhido with gundruk soup, dal, and fresh achar.",
                price: 300,
                category: "Nepali",
                rating: 4.7,
                isPopular: false,
            ...
            {
                restaurantId: restaurants[9]._id,
                name: "Traditional Khaja Set",
                image: "https://images.unsplash.com/photo-1534422298391-e4f8c172dddb?w=500",
                description: "Chiura, alu tama, bhatmas, eggs, and achar — the classic Nepali snack platter.",
                price: 250,
                category: "Nepali",
                rating: 4.8,
                isPopular: true,
            },
            {
                ...
                name: "Chowmin",
                image: "https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?w=500",
                description: "Nepali-style stir-fried noodles with chicken and fresh vegetables.",
                price: 220,
                category: "Noodles",
                rating: 4.5,
                isPopular: false,
